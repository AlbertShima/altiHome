...
public class SozialbauStepDefinition {
    ...
    public void you_search_for_vienna_all_the_options() throws Exception {
        for (int i = 1; i <= 10; i++) {
            ...
            if ((address.getText().contains("Wien") && Integer.parseInt(numberOfRooms.getText()) == 3 && (Integer.parseInt(price.getText().substring(2, price.getText().length() - 3).replaceAll("\\.", ""))) <= 1200)) {
